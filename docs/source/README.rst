...
## What is it? EasyPred is a Python package that allows to
...
Why EasyPred can be useful: - **All-in-one bundle**: having data and
accuracy metrics in a single object means less stuff you need to keep an
eye on - **Minimize code redundancy**: pass the data once and get all
the information and metrics you want - **Easy and flexible comparison**:
create the predictions first and then decide what to compare. Changed
your mind? The object is there, simply access another method
...
EasyPred depends on the following libraries: - NumPy - pandas
...
.. |GitHub license| image:: https://badgen.net/github/license/FilippoPisello/EasyPred
   :target: https://github.com/FilippoPisello/EasyPred/blob/main/LICENSE
.. |PyPI version fury.io| image:: https://badge.fury.io/py/easypred.svg
   :target: https://pypi.org/project/easypred/
